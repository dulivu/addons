...
var num = document.getElementById('monto-total').innerText;
document.getElementById('total-texto').innerText = convertirNumLetras(num);
//document.getElementById('total-texto').innerText = 'Valor de total-texto';